...
<div class="feedback feedback-toggle rotate" id="tab" >Feedback</div>
<div class="feedback feedback-form-wrapper">
    <form id="feedback-form" class="form-horizontal">
        ...
        <label>Name</label>
        <input type="text" id="username"  	data-validation='{"required":true,"type":"text"}' 	name="name" class="input-block-level"   >
        <label>Email</label>
...
<script>
    ...
    $("#feedback-form .btn").click(function() {
		var url = 'feedbacks/submit', // the script where you handle the form input.
