<div class="row-fluid">
	<div class="span8">
		<div class="well">
			...
			<p>
				<a class="btn btn-primary btn-large" href="<?php echo $this->Xyz->u( 'article', 'index', 'bhagat-singh-introduction-article' ); ?>">Read more »</a>
			</p>
		</div>
	</div>
...
<div class="row-fluid">
	<div class="span4">
		...
		<p>
			<a class="btn" href="<?php echo $this->Xyz->u( 'quotes' ); ?>">More Quotes »</a>
		</p>
	</div>
	<div class="span4">
		<h2>
		...
		?>
		<p>
			<img class="img-polaroid" src="<?php echo $this->webroot . 'img/gallery/images('. $j . ')' ?>" width="250" height="250" alt="" />
		</p>
		<p>
			<a class="btn" href="<?php echo $this->Xyz->u( 'images', 'all' ) ?>">More Images »</a>
		</p>
	</div>
	<div class="span4">
		<h2>
