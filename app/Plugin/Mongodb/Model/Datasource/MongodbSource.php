 ...
 */
    public function describe($Model) {
        $primaryKey = isset( $Model->primaryKey ) ? $Model->primaryKey : '_id';
 ...
 */
    public function create(Model $Model, $fields = null, $values = null) {
        ...
        if (!empty($return) && $return['ok']) {
            ...
            $id = $data[$primaryKey];
            if($this->config['set_string_id'] && is_object($data[$primaryKey])) {
                $id = $data[$primaryKey]->__toString();
            }
 ...
 */
    public function update(Model $Model, $fields = null, $values = null, $conditions = null) {
        ...
        if (!empty($data['_id'])) {
            $this->_convertId($data['_id']);
            $cond = array($primaryKey => $data[$primaryKey]);
